...
JNIEXPORT jlong JNICALL Java_com_badambiz_library_zplog_core_JniLog_newXlogInstance
...
JNIEXPORT jlong JNICALL Java_com_badambiz_library_zplog_core_JniLog_getXlogInstance
...
JNIEXPORT void JNICALL Java_com_badambiz_library_zplog_core_JniLog_releaseXlogInstance
    (JNIEnv *env, jobject, jstring _nameprefix) {
    ScopedJstring nameprefix_jstr(env, _nameprefix);
    mars::xlog::ReleaseXloggerInstance(nameprefix_jstr.GetChar());
}

JNIEXPORT void JNICALL Java_com_badambiz_library_zplog_core_JniLog_appenderOpen
...
JNIEXPORT void JNICALL Java_com_badambiz_library_zplog_core_JniLog_appenderClose(JNIEnv *env, jobject) {
    mars::xlog::appender_close();
}

JNIEXPORT void JNICALL Java_com_badambiz_library_zplog_core_JniLog_appenderFlush(JNIEnv *env, jobject, jlong _log_instance_ptr, jboolean _is_sync) {
    CHECK_LOG_INSTANCE(_log_instance_ptr);
    mars::xlog::Flush(_log_instance_ptr, _is_sync);
}

JNIEXPORT void JNICALL Java_com_badambiz_library_zplog_core_JniLog_logWrite
...
JNIEXPORT void JNICALL Java_com_badambiz_library_zplog_core_JniLog_logWrite2
...
JNIEXPORT void JNICALL Java_com_badambiz_library_zplog_core_JniLog_setLogLevel
  (JNIEnv *, jobject, jlong _log_instance_ptr, jint _log_level) {
    CHECK_LOG_INSTANCE(_log_instance_ptr);
    mars::xlog::SetLevel(_log_instance_ptr, (TLogLevel)_log_level);
}

JNIEXPORT void JNICALL Java_com_badambiz_library_zplog_core_JniLog_setAppenderMode
...
JNIEXPORT void JNICALL Java_com_badambiz_library_zplog_core_JniLog_setConsoleLogOpen
  (JNIEnv *env, jobject, jlong _log_instance_ptr, jboolean _is_open) {
    CHECK_LOG_INSTANCE(_log_instance_ptr);
    mars::xlog::SetConsoleLogOpen(_log_instance_ptr, _is_open);
}

JNIEXPORT void JNICALL Java_com_badambiz_library_zplog_core_JniLog_setMaxFileSize
        (JNIEnv *env, jobject, jlong _log_instance_ptr, jlong _max_size) {
    CHECK_LOG_INSTANCE(_log_instance_ptr);
    mars::xlog::SetMaxFileSize(_log_instance_ptr, _max_size);
}

JNIEXPORT void JNICALL Java_com_badambiz_library_zplog_core_JniLog_setMaxAliveTime
